#' @name dg_query_builder
#' @title Build a query in `GraphQL` syntax
#'
#' @description Builds a query in `GraphQL` syntax through a recursive function
#'   that iterates over the fields defined in `define_fields()`. It checks for
#'   possible arguments and subfields and pastes names and values, respectively.
#'
#' @param field Field of "highest order" where the recursive function starts.
#'   Usually query_list, defined in define fields.
...
#'
#' @examples
#' # dg_query_builder(field, lastfield_name)
#' @export
...
#' 
#' @inheritParams dg_query_builder
#' 
#' @export
