...
You can also use `dg_search` to look for a variable of interest. The function will match your string with any strings in the data frame, returning only rows with those matches.
